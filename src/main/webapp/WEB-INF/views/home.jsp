...
<script src="<%=application.getContextPath()%>/resources/js/garam/bugs_vue.js"></script>
<script src="<%=application.getContextPath()%>/resources/js/garam/bugs.js"></script>
<script src="<%=application.getContextPath()%>/resources/js/garam/page_vue.js"></script>
<script>
